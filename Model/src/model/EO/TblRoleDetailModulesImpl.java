...
// ---    Mon Jan 06 13:06:15 PKT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TblRoleDetailModulesImpl extends EntityImpl {
    /**
    ...
    public static final int TBLMODULEMENU = AttributesEnum.TblModuleMenu.index();
    public static final int TBLROLEMASTER = AttributesEnum.TblRoleMaster.index();

    /**
     * This is the default constructor (do not remove).
     */
    public TblRoleDetailModulesImpl() {
    }
    ...
    /**
     * Gets the attribute value for ModuleMenuId, using the alias name ModuleMenuId.
     * @return the value of ModuleMenuId
     */
    public Number getModuleMenuId() {
        return (Number) getAttributeInternal(MODULEMENUID);
    }

    /**
     * Sets <code>value</code> as the attribute value for ModuleMenuId.
     * @param value value to set the ModuleMenuId
     */
    public void setModuleMenuId(Number value) {
        setAttributeInternal(MODULEMENUID, value);
    }
     ...
     */
    public EntityImpl getTblModuleMenu() {
        return (EntityImpl) getAttributeInternal(TBLMODULEMENU);
    }

    /**
     * Sets <code>value</code> as the associated entity oracle.jbo.server.EntityImpl.
     */
    public void setTblModuleMenu(EntityImpl value) {
        setAttributeInternal(TBLMODULEMENU, value);
    }
    ...
    /**
     * @param roleDetailModulesId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Number roleDetailModulesId) {
        return new Key(new Object[] { roleDetailModulesId });
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.EO.TblRoleDetailModules");
    }
